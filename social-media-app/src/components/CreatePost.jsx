...
return(
  ...
  <div class="mb-3">
    ...
    <input type="text"
    ref={postTitleElement} className="form-control" id="title"
    placeholder="How are you feeliong today?" />
    </div>
  ...
  <div class="mb-3">
    ...
    ref={reactionsElement} className="form-label">Number of reactions</label>
    <textarea type="text" class="form-control" id="reactions"
    placeholder="How many people reacted to this post." />
    </div>

  <div class="mb-3">
    <label htmlFor="tags" class="form-label">Enter your tags here</label>
    <textarea type="text"
